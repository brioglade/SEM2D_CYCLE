function [a] = computeforce_combine_force(iglob,W,Wl,H,Ht,d,Iglob,coefint1, coefint2)
...
%   Detailed explanation goes here
    ...
    ax = zeros(NGLOB,1);
    az = zeros(NGLOB,1);
    d(Iglob(:,2),2) = d(Iglob(:,1),2); % make a copy of displacement field.
    for e=1:NEL              
    ...
    a(:,1) = ax;
    a(:,2) = az;
    a(Iglob(:,1),2) = a(Iglob(:,1),2) +  a(Iglob(:,2),2); % combine vertical forces
    a(Iglob(:,2),2) = 0;
end
