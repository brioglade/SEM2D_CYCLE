 function [dnew,n] = myPCGnew7_parallel(coefint1,coefint2,diagKnew,dnew,F,slip,Iglob,NIglob,H,Ht,iglob,NEL,nglob,W,Wl,FixBoundary,x,y,tolerance);
...
a = computeforce_slip_boundary_parallel(iglob,W,Wl,H,Ht,dd,slip,Iglob,coefint1,coefint2);% combine vertical stresses 
a(FixBoundary,:) = 0;
...
for n = 1:4000
%    norm(rnew)
    a = computeforce_slip_boundary_parallel(iglob,W,Wl,H,Ht,p,slip*0,Iglob, coefint1,coefint2);
    a(FixBoundary,:) = 0;
    anew = a;
